import platform, subprocess, os, psutil
import mlx.core as mx

class HardwareMatrix:
    def __init__(self):
        self.os_type = platform.system()
        self.mps_available = hasattr(mx, 'metal') and mx.metal.is_available()
    ...
    def get_specs(self) -> dict:
        ...
        return {"chip": self.chip_info, "mps": self.mps_available, "uma_gb": self.total_mem, "cpu_cores": self.cpu_cores, "tier": tier}
